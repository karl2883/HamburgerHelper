...
[CustomEntity("HamburgerHelper/DarkAngelRefill")]
public class DarkAngelRefill : Entity
{
    ...
    private static readonly ParticleType P_Regen = new ParticleType(Refill.P_Regen)
    {
        ...
        SpeedMin = 40f,
        SpeedMax = 60f,
        Color = Calc.HexToColor("1b1631"),
        Color2 = Calc.HexToColor("2b1c47"),
        
        SpinMin = -MathHelper.Pi / 6f,
        SpinMax = MathHelper.Pi / 6f,
    };
    ...
    public DarkAngelRefill(EntityData data, Vector2 offset) 
        : base(data.Position + offset)
    {
        ...
        Outline = new Image(GFX.Game["objects/hamburger/darkangel/outline00"]);
        Outline.CenterOrigin();
        Outline.Visible = false;
        Add(Outline);
        
        Sprite = new Sprite(GFX.Game, "objects/hamburger/darkangel/");
    ...
    private void OnPlayer(Player player)
    {
        ...
        HasDarkAngelWings = true;
        
        Collidable = false;
        
        Audio.Play("event:/HamburgerHelper/sfx/angel_wing_flap", Position);
